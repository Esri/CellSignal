 ...
 * LineChart
 */
open class LineChartCustom: UIView {
    ...
    */
    ...
    public var hardMax: CGFloat? = nil
    public var hardMin: CGFloat? = nil
    ...
    fileprivate func drawXLabels() {
        ...
        for (index, _) in xAxisData.enumerated() {
            ...
            if let labelsX = labelsX {
                if Int(index) < labelsX.count {
                    text = labelsX[Int(index)]
                }
            } else {
    ...
    fileprivate func drawYLabels() {
        ...
        for i in stride(from: start, through: stop, by: step){
            ...
            label.font = UIFont.preferredFont(forTextStyle: UIFontTextStyle.caption2)
            label.textAlignment = .center
            /*if let labelsY = labelsY {
                if Int(i) < labelsY.count {
                    label.text = labelsY[Int(i)]
                }
            } else {*/
